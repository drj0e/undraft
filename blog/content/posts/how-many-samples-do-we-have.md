...
None of the hard part is technical. The modeling is tractable. The stewardship is the gap.
...
The catalog, the semantic layer, the contract tooling: you can buy every bit of it. A data steward who will own what a sample is, you have to appoint, and that's the line item nobody puts on a roadmap.
